      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Kebijakan Privasi ini menjelaskan bagaimana {settings?.siteName || 'MarketHub'} mengumpulkan, menggunakan, dan melindungi informasi pribadi Anda saat menggunakan layanan kami.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 prose prose-sm max-w-none">
          <div className="space-y-6 text-gray-700 whitespace-pre-wrap">
            {settings?.privacyPolicy || 'Memuat kebijakan privasi...'}
          </div>
        </div>
      </main>
